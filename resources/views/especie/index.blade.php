...
@section('content')
    ...
    @include('especie.modal-create')
    @include('especie.modal-edit')
@endsection
...
@section('scripts')
    ...
    <script>
        function getEspecie(especies) {
      
            if (estado == 0) {
                $('#editar').slideDown('fast');
                $('#crear_nuevo').slideUp('fast');
            }
            $('#nombre').val(especies.nombre);
           $('#especieid').val(especies.id);
        }
