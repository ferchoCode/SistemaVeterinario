<!-- Modal -->
<div class="modal fade" id="edit_especie" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <form class="form" id="formUpdate" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" class="form-control" name="especieid" id="especieid"
                  value="{{ old('especieid') }}" autofocus />
                </div>
